...
| FR-003 | A workspace can create an HTTP or HTTPS link with a server-generated CUID slug. Vanity slugs are planned for v1.1. | API contract, validation, and browser scenario. | in progress |
...
| FR-005 | Redirect analytics record clicks, daily unique visitors, referrer host, country, and device category. | Aggregation integration tests. | planned |
