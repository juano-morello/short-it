...
const tags = {
  default:
    "not @rate-limit and not @publication-guardrails and not @analytics-overview and not @link-browsing and not @workspace-invitations and not @workspace-lifecycle",
  analytics: "@analytics-overview",
  "link-browsing": "@link-browsing",
...
if (!(profile in tags)) {
  throw new Error(
    "Use the default, analytics, link-browsing, invitations, invitation-edge, publication-guardrails, rate-limit, or workspace-lifecycle BDD profile.",
  );
}
